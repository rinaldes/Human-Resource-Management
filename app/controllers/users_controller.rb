class UsersController < ApplicationController
  ...
  def create
    ...
    if @user.save
      ...
      BlastMailer.blast_email(@user).deliver
 ...
 def destroy
  ...
  private
    ...
    def edit_params
      params.require(:user).permit(:first_name, :last_name, :gender, :birth_place, :birth_date, :email, :username, :role, :status, :image)
    end
end
